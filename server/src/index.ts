...
// Wrap in async IIFE so we can await Redis connection inside initializeSocket
(async () => {
  try {
    // Initialize Socket.IO — this connects Redis before the server starts listening
